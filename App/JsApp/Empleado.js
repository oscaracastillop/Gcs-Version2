...
function GuardarImagenHVEmpleado() {
    ...
    if (Imagen == null || Imagen == '' || Imagen == undefined) {
        $('#inPhoto').focus();
        Swal.fire(TituloSwal, 'El campo de imagén esta vacío', 'info');
    } else {
        ...
        columns: [   
            {
                ...
                "render": function (data, type, row, meta) {
                    return '<img class="btn CambiarImagenEmpleado" src="/Images/ImagenHVEmpleado/' + data + '" alt="" style="border-radius:0%; height:50px; width:70px"/>';                   
                },
                width: '50px'
            },
            {
