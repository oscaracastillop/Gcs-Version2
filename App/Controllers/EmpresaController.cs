...
namespace SistemaGcs.App.Controllers
{
    public class EmpresaController : Controller
    {
        ...
        public JsonResult CrearEmpresa(string IdUser, string NombreEmpresa, int IdTipoDocumento, string Identificacion, string Email, string Telefono, string Celular, string Contacto, int IdTipoDocumentoRL, string IdentificacionRL, int IdCiudadExpedicion, int IdCiudad, string Direccion, string Descripcion)
        {
            var resultado = dataEmpresa.CrearEmpresa(IdUser, NombreEmpresa, IdTipoDocumento, Identificacion, Email, Telefono, Celular, Contacto, IdTipoDocumentoRL, IdentificacionRL, IdCiudadExpedicion, IdCiudad, Direccion, Descripcion);
        ...
        {
            var resultado = dataEmpresa.ActualizarEmpresa(IdUser, IdEmpresa, NombreEmpresa, IdTipoDocumento, Identificacion, Email, Telefono, Celular, Contacto, IdTipoDocumentoRL, IdentificacionRL, IdCiudadExpedicion, IdCiudad, Direccion, Descripcion, IdEstado);
            return Json(resultado);
        }
