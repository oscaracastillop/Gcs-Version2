...
namespace App.Controllers
{
    public class Contrato_LaboralController : Controller
    {
        ...
        public JsonResult CrearCLE(string IdUser,
                                    int IdEmpleado,
                                    int IdEmpresa,
                                    int IdCargo,
                                    int IdTipoContrato,
                                    ...
                                    string Observacion)
        {
            var resultado = dataContratoLaboral.CrearCLE(
                    IdUser,
                    IdEmpleado,
                    IdEmpresa,
                    IdCargo,
        ...
        public JsonResult ActualizarCLE(string IdUser, int IdCLE, int IdTipoContrato, int SalarioMensual, string FechaFin, int IdEps,
                                    decimal PorcentajeContEps,
                                    int IdFondoPension,
                                    decimal PorcentajeContFP,
                                    int IdBanco,
        ...
        {
            var resultado = dataContratoLaboral.ActualizarCLE(IdUser, IdCLE, IdTipoContrato, SalarioMensual, FechaFin, IdEps,
                    PorcentajeContEps,
                    IdFondoPension,
                    PorcentajeContFP,
                    IdBanco,
                    NumeroCuentaPago,
                    SubTransporte,
                    IdCesantias, Observacion, IdEstado);
            return Json(resultado);
        }
