    ...
    public class DataPermisoSubMenu
    {
        ...
        public string CrearPermisoSubMenu(string IdUser, int IdUsuarioSubMenu, int IdSubMenu, int Permiso, int Crear, int Editar, int Eliminar)
        {
            ...
            try
            {
                ...
                var varPermiso = new SqlParameter("@Permiso", SqlDbType.Int) { Value = Permiso };
                ...
                _conection.Database.ExecuteSqlCommand("SP_CrearPermisoSubMenu @IdUser, @IdUsuarioSubMenu, @IdSubMenu, @Permiso, @Crear, @Editar, @Eliminar, @Resultado OUTPUT", varIdUser, varIdUsuarioSubMenu, varIdSubMenu, varPermiso, varCrear, varEditar, varEliminar, varResultado);
        ...
        public string ActualizarPermisoSubMenu(string IdUser, int IdPermisoSubMenu, int IdUsuarioSubMenu, int IdSubMenu, int Permiso, int Crear, int Editar, int Eliminar)
        {
            ...
            try
            {
                ...
                _conection.Database.ExecuteSqlCommand("SP_ActualizarPermisoSubMenu @IdUser, @IdPermisoSubMenu, @IdUsuarioSubMenu, @IdSubMenu, @Permiso, @Crear, @Editar, @Eliminar, @Resultado OUTPUT", varIdUser, varIdPermisoSubMenu, varIdUsuarioSubMenu, varIdSubMenu, varPermiso, varCrear, varEditar, varEliminar, varResultado);
